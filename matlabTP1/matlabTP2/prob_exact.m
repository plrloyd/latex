...
function [ EL2, EH1 ] = prob_exact( nom_maillage, xi, num, validation, visualisation )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% prob_exact :
...
%          
% INPUT * nom_maillage, xi, verification, validation  : nom du maillage
%                                                       utilise, micro
%                                                       periode , numero du
%                                                       cas test
%                                                       options de tests et
...
for l=1:Nbtri
  ...
  % calcul des matrices elementaires du triangle l 
   ...
   Kel=matKvar_elem(S1, S2, S3, xi, num);
...
FF = f_exact(Coorneu(:,1),Coorneu(:,2),xi,num);
LL = MM*FF;
